...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      ref={ref}
      className={`reveal-on-scroll mx-auto flex max-w-6xl flex-col items-center gap-10 px-4 pt-10 md:flex-row md:items-stretch md:gap-16 md:px-6 lg:pt-14 ${
    ...
    >
      ...
      <div className="order-1 flex w-full justify-center md:order-2 md:w-1/2">
        <div className="hero-photo-float relative h-60 w-60 rounded-full bg-gradient-to-b from-[#F2F5FF] to-[#E4F2FF] shadow-[0_18px_40px_rgba(101,75,255,0.18)] sm:h-72 sm:w-72 md:h-80 md:w-80">
          ...
          <div className="absolute -top-3 -right-2 h-10 w-10 rounded-full bg-[#E1E6FF]" />
          <div className="absolute bottom-6 -left-4 h-16 w-16 rounded-full bg-[#E6F7FF]" />
        </div>
      </div>
    </section>
  );
